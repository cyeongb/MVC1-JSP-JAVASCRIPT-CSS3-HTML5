...
networkBoardBean bb=fbdao.contentboard(num);

%>
<article>
<h1><i>네트워크 글쓰기(관리자전용) </i></h1>
...
<img src="../upload/<%=bb.getFile() %>" width="80" height="80"  onclick="view_original()">
<input type="hidden" value="<%=bb.getFile() %>" name="file_name">
<img src="../upload/<%=bb.getFile() %>"  hidden name="file_size">
<% if(bb.getFile()==null){
%><h3><i>No  f i l e.</i></h3>	
<%}%></td></tr>
<tr><td class="tno">글내용</td><td><textarea name="content" rows="30" cols="40" readonly><%=bb.getContent() %></textarea></td> </tr>
</table>
<div id="table_search">
<%
//세션값 가져오기
...
onclick="location.href='networkUpdateForm.jsp?num=<%=bb.getNum()%>'">
<input type="button" value="글삭제" class="btn" 
onclick="location.href='networkDeleteForm.jsp?num=<%=bb.getNum()%>'">		
		<%
	}
}
%>
